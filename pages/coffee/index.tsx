        ...
        <GridSection>
          <Box>
            ...
            <Text className={coffeeStyles.heroBody} fontSize={['16px', '18px', '24px', '24px']}>
              ...
              praesentium iste nihil optio incidunt repellat culpa ratione. Error eius neque voluptas ipsum recusandae,
              id, numquam, fugiat molestiae laboriosam repellendus necessitatibus est.
            </Text>
            <Center margin={4}>
